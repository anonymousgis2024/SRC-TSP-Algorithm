...
def SRC_LKH_main_scen_2(file1,file2,start,not_selected):
    """
    ...
    must_points.append(init_must_points[6])
    types = list()
...
if __name__ == '__main__':
    ...
    In addition to the starting point, the path must contain another mandatory node.
    ...
    """
    SRC_LKH_main_scen_2(Coordinate_And_Semantics, Distance_Of_Road_Network,start=0,not_selected=[0,1])
